                ...
                <div class="p-6 text-gray-900 max-w-xl">
                    <form action="{{ route('departments.store') }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="name" id="name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('name') }}" required placeholder="e.g. DME">
                        ...
                        <div class="flex justify-end space-x-3 border-t pt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Save Department</button>
                        </div>
                    </form>
                </div>
            </div>
