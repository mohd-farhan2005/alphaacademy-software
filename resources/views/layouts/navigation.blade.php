<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block fill-current text-gray-800" style="width: 200px; height: auto;" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user()->role === \App\Enums\RoleType::EMPLOYEE)
                    <x-nav-link :href="route('employees.show', Auth::user())" :active="request()->routeIs('employees.show')">
                        {{ __('Performance') }}
                    </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(Auth::user()->role === \App\Enums\RoleType::EMPLOYEE)
            <x-responsive-nav-link :href="route('employees.show', Auth::user())" :active="request()->routeIs('employees.show')">
                {{ __('Performance') }}
            </x-responsive-nav-link>
            @endif
